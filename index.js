...
client.connect(err => {
    ...
    const carCollection = client.db(`${process.env.DB_NAME}`).collection("cars");
    ...
    app.post('/addCar', (req, res) => {
      ...
      app.delete('/car/deleteCar/:id',(req, res) => {
    ...
    app.patch('/car/editCar/:id',(req, res) => {
        const id=req.params.id
        const carName = req.body.carName
        const carDiscription = req.body.carDiscription
        const price = req.body.price
